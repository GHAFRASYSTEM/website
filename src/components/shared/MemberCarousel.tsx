...
function getPosition(offset: number) {
  // Returns inline styles for each position: size, opacity, x-translate, z-index
  if (offset === 0) {
    return {
  ...
  if (abs === 1) {
    return {
      ...
      opacity: 0.7,
      transform: `translateX(${dir * 0}px) scale(1)`,
      zIndex: 10,
      ring: false,
    }
  }
...
export default function MemberCarousel({ images }: MemberCarouselProps) {
  ...
  // Build 5 slots: offsets -2, -1, 0, 1, 2
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative flex items-center justify-center gap-3 sm:gap-5 md:gap-7">
