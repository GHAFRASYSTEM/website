...
values:
  - title: Solidarity
    description: We stand together as one people — in joy, in struggle, and in
      growth. We look out for one another, especially newcomers and those in
      need, and respond collectively when any member faces hardship.
    icon: heart
  - title: Cultural Pride
    description: We represent our community and our homeland with dignity in all
      settings. We celebrate our shared Ghanaian identity and embrace diversity
